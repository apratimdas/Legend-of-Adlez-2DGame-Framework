...
public class EnemyMovementScriptFinal : MonoBehaviour {
    ...
    void FixedUpdate()
    {
        if (player)
        {
            ...
            GetComponent<Rigidbody2D>().AddForce(gameObject.transform.up * (speed + GameManagerScriptFinal.Instance.GetWave() / 5));
        }
    }
}
